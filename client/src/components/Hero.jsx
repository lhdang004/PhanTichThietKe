...
import { assets, cities } from "../assets/assets/assets.js"; // Make sure this file exists and exports assets
...
const Hero = () => {
  return (
    ...
    >
      <p className="bg-[#49B9FF]/50 px-4 py-2 rounded-full mt-20">
      ...
      <p className="mt-4 text-sm md:text-base lg:text-lg">
        Book your stay now and enjoy exclusive offers.
      </p>
